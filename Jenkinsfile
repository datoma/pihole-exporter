pipeline {
  environment {
    DOCKERHUB_IMAGE_NAME = 'datoma/pihole-exporter'
    ARTIFACTORY_IMAGE_NAME = 'datoma.jfrog.io/docker-local/pihole-exporter'
    dockerHubImageLatest = ''
    dockerHubImagetag = ''
    artifactoryImageLatest = ''
    artifactoryImageTag = ''
    
    GIT_URL = 'git@github.com:datoma/pihole-exporter.git'
    GIT_BRANCH = 'master'
  ...
  options {
    buildDiscarder(logRotator(numToKeepStr: '', artifactNumToKeepStr: '15'))
